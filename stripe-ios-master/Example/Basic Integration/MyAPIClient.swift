...
class MyAPIClient: NSObject, STPCustomerEphemeralKeyProvider {
    ...
    func createCustomerKey(withAPIVersion apiVersion: String, completion: @escaping STPJSONResponseCompletionBlock) {
        ...
        urlComponents.queryItems = [URLQueryItem(name: "api_version", value: apiVersion), URLQueryItem(name: "customer_id", value: "cus_GxWfqROpWSK9uA")] //TODO: Edit customerID so it changes dynamically
